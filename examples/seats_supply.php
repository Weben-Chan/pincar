                                ...
                                <div class="card-content table-responsive">
                                    <table class="table"style='text-align: center'>
                                        ...
                                        for ($i=0;$i<$myseats_count;$i++){
                                            ...
                                            $nice = updniceo($info_id,$my_arr['name']);
                                            ?>
                                            <tr>
                                                <td>
                                                ...
                                                <?php
                                                    $psg_result = mysqli_query($conn,"SELECT * FROM `pin_rec`  WHERE info_id = '$info_id'");

                                                    $psg_count = mysqli_num_rows($psg_result);
                                                    for ($j=0;$j<$psg_count;$j++) {
                                                        $psg_arr = mysqli_fetch_array($psg_result, MYSQLI_ASSOC);
                                                        $psg_id = $psg_arr['psg_id'];
                                                        $psgo_result =mysqli_query($conn,"SELECT * FROM `user` WHERE id = '$psg_id'");
                                                        $psgo_arr = mysqli_fetch_array($psgo_result,MYSQLI_ASSOC);
                                                        echo $psgo_arr['name'];echo  " ".$psgo_arr['department']."<br>" ;
                                                    }
                                                ?>
                                                        </td>
