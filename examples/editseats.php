...
$seats_result = mysqli_query($conn,"SELECT * FROM `seatsinfo` WHERE info_id = '$info_id'");
$seats_arr = mysqli_fetch_array($seats_result,MYSQLI_ASSOC);
?>
	                    ...
	                    <div class="col-md-12">
	                        <div class="card">
	                            <div class="card-header" data-background-color="purple">
	                                <h4 class="title">更改空座位</h4>
	                                <p class="category">Fill in the information.</p>
	                            </div>
                                                <form action="../carpool/editseats_server.php" method="post">
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <input type="text" name="date" value="<?php echo $seats_arr['date'];?>" class="form-control" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group label-floating">
                                                                <label class="control-label">时间</label>
                                                                <input type="text" name="time" value="<?php echo $seats_arr['time'];?>" class="form-control" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="form-group label-floating">
                                                                <label class="control-label">座位数</label>
                                                                <input type="text" name="seats" value="<?php echo $seats_arr['seats'];?>" class="form-control" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group label-floating">
                                                                ...
                                                                <input type="text" id="tipinput"  name="startaddr" value="<?php echo $seats_arr['startaddr'];?>" class="form-control" >
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <div class="form-group label-floating">
                                                                <label class="control-label">终点</label>
                                                                <input type="text" id="tipinputo" name="finaladdr" value="<?php echo $seats_arr['finaladdr'];?>" class="form-control" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="info_id" value="<?php echo $info_id;?>">
                                                    <div class="row">
                                                        <button type="submit" name="submit" class="btn btn-primary pull-right">换好姿势了</button>
                                                    </div>
